...
- QA/test account activity (qa-bot, QA Automation, Acme QA Test Suite)
...
<triage>
  ...
  <reasoning>
    Activity from qa-bot@acme.com account with "QA Automation Bot" user display name.
    ...
    this is from known QA testing infrastructure (Acme QA Test Suite).
  </reasoning>
  <next_actions>
...
<triage>
  ...
  <reasoning>
    Employee sarah.jenkins@acme.com accessing 6 customer loan applications outside
    their assigned portfolio. Source is corporate laptop (ACME-LAPTOP-1234), indicating
  ...
  <iocs>
    ...
    <ioc>ACME-LAPTOP-1234.corp.acme.com</ioc>
  </iocs>
</triage>
</examples>
